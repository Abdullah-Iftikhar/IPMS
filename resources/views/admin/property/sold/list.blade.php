                    ...
                    <div class="card-body card-dashboard">
                        <form action="" method="get">
                            <div class="row">
                                <div class="col-12 mb-1">
                                    <p class="float-left">
                                        <strong class="font-size-large">Total Sold Properties: <span
                                                class="text-info">{{$soldPropertiesCounter}}</span></strong>
                                    </p>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <small class="clear-filter">
                                        <a href="{{route('admin.property.sold')}}">Clear Filter</a>
                                    </small>
                                </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                    ...
                                    @if(count($soldProperties) > 0)
                                        <table class="table">
                                            ...
                                            @foreach($soldProperties as $key=>$property)
                                                @if($property->getSoldDetail)
                                                    <tr>
                                                        <td>{{$key+1}}</td>
                                                        <td>{{$property->society}}</td>
                                                        <td>
                                                            <a href="{{route('admin.sold.property.detail', $property->id)}}">
                                ...
                                @endphp
                                @include('include.pagination',['paginator' => $soldProperties->appends($arra)])
                            </div>
                        </div>
                    </div>
                </div>
