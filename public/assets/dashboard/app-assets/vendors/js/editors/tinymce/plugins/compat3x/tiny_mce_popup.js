...
var tinyMCEPopup = {
	...
	/**
	 * Executes a color picker on the specified element id. When the employee
	 ...
	 * @param {function} cb Callback function to be executed after the employee has selected ok or cancel.
	 ...
	 * @param {function} cb Callback function to be executed after the employee has selected ok.
	 * @param {Object} s Optional scope to execute the callback in.
	 */
...
/*	_restoreSelection : function() {
		...
		// If employee focus a non text input or textarea
